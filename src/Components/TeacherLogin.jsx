...
const TeacherLogin = () => {
    return (
        <div className="mt-16 w-full max-w-md p-8 space-y-3 rounded-xl mx-auto bg-gray-50 text-gray-800">
            <h1 className="text-2xl font-bold text-center">Login as Teacher</h1>
            ...
            <p className="text-xs text-center sm:px-6 text-gray-600">Don't have an account?
                <a rel="noopener noreferrer" href="/teacherRegister" className="underline text-gray-800">Sign up</a>
            </p>
        </div>
    );
};

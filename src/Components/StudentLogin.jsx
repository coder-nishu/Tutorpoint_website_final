...
const StudentLogin = () => {
	...
	<h1 className="text-2xl font-bold text-center">Login as Student</h1>
	...
	<p className="text-xs text-center sm:px-6 text-gray-600">Don't have an account?
		<a rel="noopener noreferrer" href="/studentRegister" className="underline text-gray-800">Sign up</a>
	</p>
</div>
    );
};
